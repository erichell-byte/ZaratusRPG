...
namespace Game.Meta
{
    public sealed class UpgradeButton : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite maxButtonSprite;

        [Space] [SerializeField] private TextMeshProUGUI priceText;

        [Space] [SerializeField] private GameObject maxTextGO;

        [Space] [SerializeField] private GameObject titleTextGO;
        ...
        public void SetState(State state)
        {
            ...
            if (state == State.AVAILABLE)
            {
                ...
                this.buttonBackground.sprite = availableButtonSprite;
            ...
            else if (state == State.LOCKED)
            {
                ...
                this.buttonBackground.sprite = lockedButtonSprite;
            ...
            {
                this.button.interactable = false;
                this.buttonBackground.sprite = maxButtonSprite;
            ...
            {
                throw new Exception("Undefined button state!");
            }
        }
